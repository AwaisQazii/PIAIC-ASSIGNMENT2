...
def function3():
    ...
    x = a[np.where((a%7==0) & (a%5==0))] #wrtie your code here
    return x
...
def function6():
    ...
    arr = np.arange(10) #wrtie your code here
    arr = arr*0
    arr[5] = 10
    arr[8] = 20  
...
def function8():
    ...
    x = np.arange(10, dtype=np.uint).reshape(2,5) #write your code here
	x = x**0*6
    return x
...
def function9():
    ...
    a = np.arange(1,51, dtype=np.uint) # write your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = (arr-brr)**0*2 # write your code here 
...
def function17():
    ...
    ans = np.where((arr % 3 == 0) & (arr % 5 == 0), 'YES', arr*0)
